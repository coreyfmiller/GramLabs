      ...
      <div className="mx-auto max-w-5xl px-4 py-6 md:px-8">
        ...
        <div className="mb-5 flex flex-wrap items-center gap-3">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <button onClick={doShare} className="inline-flex items-center gap-1 rounded-lg bg-foreground px-2.5 py-1.5 text-xs font-medium text-background"><Share2 size={14} /> Share</button>
