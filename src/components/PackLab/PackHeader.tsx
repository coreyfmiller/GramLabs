      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-white/[0.05] border border-border hover:border-white/20 transition-colors"
          ...
          <button
            onClick={handleShare}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-white/[0.05] border border-border hover:border-lime-400/30 hover:text-lime-400 transition-colors text-white/60"
          >
            {shareMessage ? (
              <>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 pb-4 flex items-center gap-4">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/[0.05] border border-border hover:border-white/20 transition-colors"
          >
          ...
          {showLoadoutMenu && (
            <div className="absolute top-full left-0 mt-1 w-56 bg-[#1a1a1a] border border-border rounded-xl shadow-xl overflow-hidden z-50">
